...
Progress so far: ImageValidator, ScaleCalibrator, Rectifier, and
EdgeDetector have concrete adapters (app.infrastructure.io.image_validator.
...
CannyFastLineEdgeDetector). The other 5 Protocols don't yet. Real wiring
in build_pipeline() below is deferred until enough stages have adapters
for it to be more than a stub calling a few classes — see
docs/architecture.md roadmap for what's next.
"""
