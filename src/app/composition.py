...
Progress so far: ImageValidator, ScaleCalibrator, and Rectifier have
concrete adapters (app.infrastructure.io.image_validator.
...
ManualCornerRectifier). The other 6 Protocols don't yet. Real wiring in
build_pipeline() below is deferred until enough stages have adapters for
it to be more than a stub calling a few classes — see docs/architecture.md
